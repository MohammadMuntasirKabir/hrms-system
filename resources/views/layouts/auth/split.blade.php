...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="min-h-screen antialiased">
        ...
        <div class="relative flex min-h-dvh flex-col lg:grid lg:grid-cols-2">
            ...
            <!-- Left: About / Branding Panel (hidden on mobile, shown on lg+) -->
            <div class="relative hidden flex-col justify-between p-12 xl:p-16 lg:flex dark:border-e dark:border-white/5 bg-gradient-to-br from-[#0c1222]/95 via-[#0f1a30]/90 to-[#0a0f1e]/95 backdrop-blur-xl">
                ...
                <div class="relative z-20 my-auto">
                    ...
                    <div class="mt-8 space-y-3.5">
                        <div class="flex items-center gap-3 text-sm text-blue-100/70">
                            <span class="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-white/5 border border-white/10">
            ...
            <div class="flex flex-1 items-center justify-center px-4 py-8 sm:px-6 lg:px-8">
                <div class="w-full max-w-[420px]">
                    <!-- Mobile logo -->
                    <a href="{{ route('dashboard') }}" class="flex flex-col items-center gap-2 font-medium lg:hidden mb-6" wire:navigate>
                    ...
                    <!-- Form card -->
                    <div class="rounded-2xl border border-white/10 bg-[#0d1117]/80 backdrop-blur-xl shadow-2xl shadow-black/40 p-6 sm:p-8">
                        {{ $slot }}
                    </div>
                </div>
            </div>
