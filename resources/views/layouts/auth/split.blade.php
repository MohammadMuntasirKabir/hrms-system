...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="min-h-screen antialiased">
        ...
        <div class="relative grid h-dvh flex-col items-center justify-center px-4 sm:px-0 lg:max-w-none lg:grid-cols-2 lg:px-0">
            <!-- Left branding panel -->
            <div class="relative hidden h-full flex-col p-12 lg:flex dark:border-e dark:border-white/5 bg-gradient-to-br from-[#0c1222]/95 via-[#0f1a30]/90 to-[#0a0f1e]/95 backdrop-blur-xl">
                ...
                <div class="relative z-20 mt-auto space-y-8">
                    <div>
                        ...
                        <flux:text class="mt-4 text-blue-100/80 leading-relaxed text-sm">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center gap-3 text-sm text-blue-100/70">
                            <span class="flex h-9 w-9 items-center justify-center rounded-lg bg-white/5 backdrop-blur-sm border border-white/10">
